...
```javascript
import Vue from 'vue';
import ElementUI from 'brizzly-ui';
import 'brizzly-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'brizzly-ui';
import App from './App.vue';
