...
<script type="text/babel">
  ...
  import Focus from 'brizzly-ui/src/mixins/focus';
  ...
  import { getValueByPath } from 'brizzly-ui/src/utils/util';
  import { valueEquals, isIE, isEdge } from 'brizzly-ui/src/utils/util';
