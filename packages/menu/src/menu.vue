<script type="text/jsx">
  ...
  import Menubar from 'brizzly-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'brizzly-ui/src/utils/dom';
      ...
      const component = (
        <ul
          ...
          class={{
            ...
            'el-menu--vertical-combined': this.mode === 'vertical-combined',
